package cn.middle.web.shiro.config;
...
import cn.middle.web.shiro.realm.AuthRealm;
import cn.middle.web.shiro.util.CredentialMatcher;
...
public class ShiroConfiguration {
    ...
    public AuthRealm authRealm(
            @Qualifier("credentialMatcher") CredentialMatcher matcher) {
        // 设置自定义的Realm
